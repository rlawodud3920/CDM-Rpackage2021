...
OhdsiRTools::checkUsagePackage("statin365")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/statin365.pdf")
shell("R CMD Rd2pdf ./ --output=extras/statin365.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("statin365")
