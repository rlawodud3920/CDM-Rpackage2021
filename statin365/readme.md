...
2. In `R`, use the following `devtools` command to install the statin365 package:
...
License
=======
The statin365 package is licensed under Apache License 2.0

Development
===========
statin365 was developed in ATLAS and R Studio.
